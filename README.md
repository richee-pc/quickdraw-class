...
| `학생용_강의원고_6시간_AISW_퀵드로우_2026.pdf` | **학생 배포용 강의원고** (6시간·70페이지 인쇄용) | 웹앱 참고자료 탭 또는 PDF 직접 열기 |
...
> 교사용 운영 메모(수집기 자동저장 URL, 운영 팁)는 `교사용_수집기_운영메모.md`에 분리했습니다.
...
1. 도입 — AI의 두 얼굴
2. 미드저니로 게임 아트 만들기
3. 나만의 퀵드로우 수집기 체험 (데이터 학습·편향, 내장 웹앱)
4. 퀵 드로우 원리 + 체험
