...
# ------------------------------------------------------------------ 수집기 체험
    ...
    st.markdown(
        ...
        학생이 직접 한 물체(예: 자동차)의 그림 데이터를 모으고,
    ...
    st.markdown(
        ...
        - **데이터 편향의 영향**: 특정 형태만 모이면, 다른 형태를 잘 못 맞힐 수 있습니다.

        예) `자동차`를 옆면 그림으로만 모아 학습하면,
        실제 테스트에서 앞면/윗면 자동차를 잘 인식하지 못할 수 있습니다.
        """
    )
